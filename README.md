...
| Data | Files | Remarks |
| --- | --- | --- |
| 246-gene inflammation gene signature | `data/inflammatory_sig_246.csv`
(rds with ENSG-ID and name) `data/inflammatory_sig_genes.rds` | From Lasry et al 2023 supplemetary table 6 |
...
| BeatAML RNAseq data | (raw count) `data/baml/baml_full_raw_count.rds` <br/> (VST) `data/baml/baml_FULL_vst_matrix.rds`
(ensembl gene list - GRCh 37.75) `data/baml/filtered_gene_baml_rnaseq.csv` <br/> (sampleinfo) `data/baml/baml_sampleinfo_rnaseq.csv` | From Tyner et al 2018 and Bottomly et al 2022 <br/> Retrieved from [BeatAML2 Github page](https://biodev.github.io/BeatAML2/) and [Vizome](http://www.vizome.org/additional_figures_BeatAML.html) |
